...
const button: ButtonInterface = {
    ...
    execute: async (interaction: ButtonInteraction, client: DiscordClient) => {
        ...
        if (existingTicket)
            return interaction.editReply({
                embeds: [ErrorEmbed.setDescription(`${icon.info.error} ***You already have a ticket opened!***`)]
            });
        ...
        await guild.channels
            ...
            .then(async (channel: TextChannel) => {
                interaction.editReply({
                    embeds: [
                        new EmbedBuilder()
                            ...
                            .setDescription(`${icon.info.success} ***Your ticket has been created: ${channel}***`)
                    ]
                });
                ...
                channel.send({
                    content: `${icon.info.announce} ${rolesToMention.join(' • ')}`,
                    embeds: [resEmbed],
